...
export default function HomePage() {
    ...
    return (
        ...
        >
            <FadeWrapper className="grid w-full h-screen grid-cols-1 gap-0 m-auto md:h-full lg:grid-cols-3 md:mt-3">
                <MotionContainer type="blur" className="w-full h-full col-span-1">
                    <CardContainer isActive={breakpoint === "xs" ? false : true} className="w-full h-full inter-var">
                        <CardBody
                            className={cn(
                        ...
                        >
                            ...
                            <CardItem as="p" translateZ="60" className="max-w-sm mt-2 text-xs text-neutral-500 md:text-sm dark:text-neutral-300">
                                Welcome to my website, enjoy!
                            </CardItem>
                            <CardItem translateZ="100" className="w-full h-[300px] md:h-[500px] mt-4 rounded-lg">
                                <LoaderImage
                                    src="/hi.jpg"
                                    alt="Draft"
                                    width={4513}
                            ...
                            <CardItem as="div" translateZ="60" className="flex flex-col flex-wrap items-start justify-start w-full gap-1 mt-5 md:flex-row md:items-center md:gap-5">
                                <Link href="mailto:thuanvuvan76@gmail.com" className="flex items-center justify-center gap-2 transition-all duration-300 ease-in-out hover:gap-1">
                                    <Mail className="w-[14px] h-[14px]" />
                                    <TypographyP title="thuanvuvan76@gmail.com" className="text-xs font-light md:text-sm" />
                                </Link>
                                <Link href="https://github.com/VanThuan76" className="flex items-center justify-center gap-2 transition-all duration-300 ease-in-out hover:gap-1">
                                    <Github className="w-[14px] h-[14px]" />
                                    <TypographyP title="VanThuan76" className="text-xs font-light md:text-sm" />
                                </Link>
                            </CardItem>
                        </CardBody>
                    </CardContainer>
                </MotionContainer>
                <MotionContainer delay={0.3} type="blur" className="col-span-1 md:col-span-2">
                    <Card className="relative w-full h-full flex flex-col justify-between items-start dark:bg-[#030712] bg-[#e8e6e6] md:bg-white rounded-none shadow-none md:shadow-lg md:rounded-xl md:border overflow-hidden">
                        ...
                        <CardHeader className="z-10 px-4 py-2 md:px-6 md:pt-6">
                            <TypewriterEffectSmooth className="mt-2 text-2xl leading-7 border-b md:my-4 border-b-neutral-300" words={[{ text: "About me..." }]} />
                        </CardHeader>
                            ...
                            <div className="items-center justify-start hidden w-full grid-cols-3 gap-3 md:grid md:grid-cols-4 md:gap-5">
                                <div className="w-full max-h-[220px] col-span-2 md:col-span-3">
                                    <DirectionAwareHover className="h-[220px]" imageUrl="/background.jpg">
                                        ...
                                        <TypographyP className="text-sm font-normal" title="🫀Stop for a moment..." />
                                    </DirectionAwareHover>
                                </div>
                                <div className="relative flex flex-col items-center justify-center w-full h-full col-span-1 overflow-hidden">
                                    <MotionContainer direction="right" delay={0.5} className="relative flex flex-col justify-center items-center w-full h-full rounded-t-lg bg-[#DCF2F1] dark:text-black cursor-pointer group" onClick={() => router.push("/project")}>
                                        <p className="text-lg font-extrabold md:text-xl lg:text-4xl">3</p>
                                    ...
                                    <MotionContainer direction="left" delay={0.5} className="relative flex flex-col justify-center items-center w-full h-full rounded-b-lg text-white dark:text-black bg-[#365486] group cursor-pointer" onClick={() => router.push("/blog")}>
                                        <h1 className="text-lg font-extrabold md:text-xl lg:text-4xl">3</h1>
                        ...
                        <CardFooter className="z-10 self-end">
                            <TypographyP title={`© Copyright ${new Date().getFullYear()} - Present Thuan`} className="text-xs text-black md:text-sm" />
                        </CardFooter>
                        <Image
                            width={250}
                            height={250}
                            src={theme !== "dark" ? "/summer-season-sun.png" : "/moon-sphere.png"}
                            alt="sub-background"
