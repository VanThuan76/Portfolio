...
export default function HomePage() {
    ...
    return (
        <FadeWrapper className={cn("relative grid w-full h-full grid-cols-1 gap-0 m-auto md:grid-cols-3")}>
            <MotionContainer
                delay={0.3}
                type="blur"
            ...
            <MotionContainer type="blur" className="order-1 w-full h-full col-span-1 md:order-2">
                <CardContainer
