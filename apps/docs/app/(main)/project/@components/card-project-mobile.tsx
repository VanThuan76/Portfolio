...
import { Drawer, DrawerTrigger, DrawerContent } from "@ui/molecules/navigation/drawer";
...
const CardProjectMobile = ({ projects }: Props) => {
    ...
    return (
        <MotionContainer delay={0.3} type="blur" className="flex flex-col items-start justify-start w-full h-screen gap-3 px-4 pt-6 md:hidden">
