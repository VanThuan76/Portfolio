...
const MainLayout = ({ children }: Props) => {
    const { initProgress, hasSleep, hasFullScreen } = useAppSelector((state) => state.app);
    ...
    return (
        <main id="container" className={cn("relative mx-auto w-screen h-screen hidden z-[2000]", initProgress === 100 && "block", breakpoint === "xs" && "bg-screen-mobile")}>
