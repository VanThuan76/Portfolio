                            ...
                            <div key={index} className="relative flex-col w-full h-full">
                                <div className="w-full h-full overflow-hidden border rounded-md border-neutral-300">
                                    <Image
                                        ...
                                        onClick={() => changeDisplay(item.value as "dark" | "light" | "system")}
                                    />
                                </div>
                                <span className="absolute text-[10px] uppercase -translate-x-1/2 -bottom-5 left-1/2">{item.value}</span>
                            </div>
                        )
                    })}
                    <div className="relative flex-col w-full h-full">
                        <div className="flex w-full h-full overflow-hidden border rounded-md border-neutral-300" onClick={() => changeDisplay("system")}>
                            <Image
                                width={150}
                                height={150}
                                alt="@displayLight"
                        ...
                        <span className="absolute text-[10px] uppercase -translate-x-1/2 -bottom-5 left-1/2">AUTO</span>
                    </div>
                </div>
            </div>
        </div>
