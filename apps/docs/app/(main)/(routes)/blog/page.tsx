      ...
      <FadeWrapper>
        <div className="bg-screen-mobile md:bg-[#F6F6F6] w-full h-full flex flex-col justify-start items-start gap-5 px-4 pt-6 md:gap-0 md:pt-2 md:px-0">
          <div className="w-full h-full flex flex-col justify-start items-start col-span-1 md:col-span-5">
            ...
            <TypographyH3
              className="mt-0 md:mt-2 translate-y-0 md:-translate-y-10"
              title="Hip Blog"
            />
            <div className="flex flex-wrap gap-2 justify-start items-center translate-y-0 md:-translate-y-10">
              ...
              <Link href="https://twitter.com/thuanhipp" target="_blank">
                <TypographyP
                  className="italic text-xs bg-gradient-to-r from-blue-400 to-blue-700 rounded-sm px-1 md:px-2 rotate-2 hover:underline"
                  title="Twitter"
                />
              </Link>
              <Link href="https://www.instagram.com/thuanhip76" target="_blank">
                <TypographyP
                  className="italic text-xs bg-gradient-to-r from-pink-500 to-purple-500 rounded-sm px-1 md:px-2 -rotate-1 hover:underline"
                  title="Intargram"
                />
              </Link>
              <Link href="https://www.threads.net/@thuanhip76" target="_blank">
                <TypographyP
                  className="italic text-xs bg-gradient-to-r from-gray-200 to-gray-500 rounded-sm px-1 md:px-2 rotate-12 hover:underline"
                  title="Threads"
                />
              </Link>
            </div>
