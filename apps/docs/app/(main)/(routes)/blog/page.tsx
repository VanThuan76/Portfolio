...
export default function Page() {
    ...
    return (
        ...
        >
            <FadeWrapper>
                <div className="relative border rounded-none md:rounded-lg shadow-none md:shadow-lg bg-screen-mobile md:bg-[#F6F6F6] dark:bg-[#030712] w-full h-screen md:h-[45rem] flex flex-col justify-start items-start gap-5 px-4 pt-6 md:gap-0 md:py-6 md:px-12 overflow-hidden">
                    ...
                    <div className="z-10 flex flex-col items-start justify-start w-full col-span-1 md:col-span-5">
                        ...
                        <TypographyH3 className="mt-0 text-xl text-white md:mt-2" title="Hip Blog" />
                        <div className="flex flex-wrap items-center justify-start gap-2">
                            <TypographyP className="text-xs italic text-white md:text-sm" title="These're my social: " />
                            <Link href="https://twitter.com/thuanhipp" target="_blank">
                                <TypographyP className="px-1 text-xs italic rounded-sm bg-gradient-to-r from-blue-400 to-blue-700 md:px-2 rotate-2 hover:underline" title="Twitter" />
                            </Link>
                            <Link href="https://www.instagram.com/thuanhip76" target="_blank">
                                <TypographyP className="px-1 text-xs italic rounded-sm bg-gradient-to-r from-pink-500 to-purple-500 md:px-2 -rotate-1 hover:underline" title="Intargram" />
                            </Link>
                            <Link href="https://www.threads.net/@austinvu76" target="_blank">
                                <TypographyP className="px-1 text-xs italic rounded-sm bg-gradient-to-r from-gray-200 to-gray-500 md:px-2 rotate-12 hover:underline" title="Threads" />
                            </Link>
                        </div>
                    </div>
                        ...
                        <div className="flex-col items-end justify-start hidden w-full h-full col-span-1 gap-3 py-5 mx-auto md:flex">
                            <HoverImageLink imgSrc="https://images.unsplash.com/photo-1713288971538-80084dbfc161?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwyfHx8ZW58MHx8fHx8">
                                <div className="pb-4 border-b cursor-pointer border-b-black dark:border-b-white">
                                    <TypographyP title="Blog" className="px-2 py-1 font-medium rounded-md" />
                                </div>
                            </HoverImageLink>
                            <div className="pb-4 border-b border-b-black dark:border-b-white">
                                <TypographyP title="Hobbies" className="px-2 py-1 font-medium rounded-md" />
                            </div>
                            <div className="pb-4 border-b border-b-black dark:border-b-white">
                                <TypographyP title="Newsletter" className="px-2 py-1 font-medium rounded-md" />
                            </div>
                        </div>
