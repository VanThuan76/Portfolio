...
export default function Page() {
    ...
    return (
        <FadeWrapper className="relative w-full h-full m-auto">
            <div className="relative border-none rounded-none md:rounded-lg shadow-none md:shadow-lg bg-screen-mobile md:bg-[#F6F6F6] dark:bg-[#030712] w-full h-full flex flex-col justify-start items-start gap-5 px-4 pt-6 md:gap-0 md:py-6 md:px-12 overflow-hidden">
