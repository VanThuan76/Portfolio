...
export default function Page() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-full h-full flex flex-col justify-start items-start gap-5 px-6 pt-6 md:gap-0 md:pt-2 md:px-0">
          <div className="w-full h-full flex flex-col justify-start items-start col-span-1 md:col-span-5">
            ...
            <div className="flex flex-wrap gap-2 justify-start items-center translate-y-0 md:-translate-y-10">
              ...
              <Link
                href={"https://www.instagram.com/thuanhip76"}
                target="_blank"
              >
                <TypographyP
              ...
              <Link
                href={"https://www.threads.net/@thuanhip76"}
                target="_blank"
              >
                <TypographyP
