...
export default async function Page({ params }: { params: { slug: string } }) {
  ...
  return (
    <div className="w-full h-full grid place-items-center overflow-hidden">
      <FadeWrapper className="relative md:bg-[#F6F6F6] dark:bg-[#030712] rounded-none md:rounded-lg border-none md:border shadow-none md:shadow-lg grid items-start justify-between w-full h-screen md:max-h-[45rem] lg:max-h-[50rem] grid-cols-1 gap-10 px-0 pt-6 mx-auto md:py-0 md:px-6 md:grid-cols-5 overflow-hidden">
