    ...
    return (
        <div className="relative w-screen h-screen p-4 md:hidden">
            <div className="flex items-center justify-between w-full gap-2">
                <MotionContainer delay={0.3} direction="left" className="relative z-20 flex-1 gap-2 overflow-hidden h-52 group max-w-52 rounded-3xl">
                ...
                <MotionContainer delay={0.3} direction="right" className="relative z-20 flex flex-col flex-1 p-2 h-52 max-w-52 rounded-3xl bg-opacity-10 bg-gradient-to-r from-gray-200 to-gray-300 bg-clip-padding backdrop-blur-sm backdrop-filter dark:from-gray-700 dark:to-gray-900">
            ...
            <MotionContainer delay={0.5} type="blur" className="grid items-center justify-center w-full grid-cols-4 gap-4">
