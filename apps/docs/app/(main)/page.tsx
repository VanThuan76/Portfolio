        ...
        <div className="relative w-screen h-screen p-4 md:hidden backdrop-blur-md md:backdrop-blur-none">
            ...
            >
                {DATA_MOBILE_MENUS.map((item, index) => (
                    <div
                        key={index}
                        className={cn("z-20 flex flex-col items-center justify-center p-2 mt-10 transition-transform transform hover:scale-105",
                    ...
                    >
                        ...
                        <div className="relative z-50 w-full h-full bg-transparent">
                            <p className="absolute z-10 w-full text-sm text-center top-2 blur-sm">{item.label}</p>
