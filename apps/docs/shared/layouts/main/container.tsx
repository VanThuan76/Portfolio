...
const MainContainer = ({ children }: Props) => {
    const { hasSleep, hasFullScreen } = useAppSelector(
        (state) => state.app,
    );
    ...
    return (
        <LazyWrapper>
            <MotionContainer id="container" type="blur" className={cn("relative mx-auto w-screen h-screen hidden", fixLayout, progress === 100 && "block", breakpoint === "xs" && "bg-screen-mobile")}>
