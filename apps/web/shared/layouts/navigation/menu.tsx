...
import { SpinningText } from "@repo/design-system/components/molecules/effects/text-spinning";
      ...
      >
        ...
        >
          <AnimatePresence mode="wait" onExitComplete={() => setIsOpen(false)}>
            {isOpen && (
              <m.div
                className="relative bg-black/[0.1] flex flex-col gap-8 justify-between h-full px-5 lg:px-10 overflow-hidden lg:flex-row"
                initial="initial"
                animate={isOpen ? "animate" : "exit"}
                variants={fadeVariants}
              >
                <div className="flex flex-col items-end justify-start order-1 w-full gap-4 mt-48 lg:mt-56 lg:gap-8 lg:order-2">
                      ...
                      >
                        <m.div
                          ...
                          onClick={(e: React.MouseEvent<HTMLDivElement>) => {
                            setIsOpen(!isOpen);
                            handleOpenScreen(e, item.href, item.name);
                          }}
                        >
