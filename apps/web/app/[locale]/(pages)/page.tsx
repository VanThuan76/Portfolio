...
const Page = () => {
    ...
    return (
        <StairsTransition>
            ...
            >
                <div className="absolute z-10 text-6xl italic font-black leading-none tracking-widest translate-x-1/2 md:text-9xl bottom-1/2 right-1/3 md:right-1/4">
                ...
                <View className="absolute top-0 right-0 z-20 flex flex-col items-center justify-center w-screen h-screen">
                    <Suspense fallback={null}>
                        <Common />
                        <Model position={["xs", "sm"].includes(breakpoint) ? [0, 30, -150] :[-30, 30, -150]} scale={["xs", "sm"].includes(breakpoint) ? [7, 7, 7] : [10, 10, 10]} />
