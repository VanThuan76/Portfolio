    ...
    <CurveTransition backgroundColor="#f8f1e8">
      <div className="relative flex flex-col items-start justify-start w-full h-full gap-2 bg-[#f8f1e8] md:gap-0 overflow-hidden">
        ...
        <div className="grid items-start justify-start w-full h-full grid-cols-1 gap-0 p-4 md:gap-2 md:grid-cols-5 md:pt-0 md:px-6">
          ...
          <div className="flex flex-col items-start justify-start order-1 w-full h-full col-span-1 gap-3 mx-auto mt-0 mb-5 overflow-hidden border-none md:mb-0 md:mt-5 md:border-r md:border-r-slate-300">
            ...
            <span className="w-auto pb-1 mt-0 border-b md:w-full md:mt-5 border-b-slate-300">
              References
            </span>
            <EmblaCarousel
