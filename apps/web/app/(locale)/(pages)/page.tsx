...
export default function Page() {
  ...
  return (
    <m.div
      ...
      className="bg-black/[0.1] relative w-full min-h-screen h-full pointer-events-auto overflow-x-hidden overflow-y-auto pb-24"
      ref={containerRef}
    >
      ...
      <section ref={ref} className="relative mt-12 md:mt-24">
        <div className="flex flex-col items-center justify-center w-full max-w-full max-h-none h-[35svh] md:h-[65svh] gap-[20px] px-0 mx-auto xl:max-h-none xl:px-32 md:flex-row xl:gap-16">
          <div className="relative px-[50px] xl:px-0 mb-[10px] xl:mb-0 xl:flex-1 flex justify-center w-full h-full md:h-auto">
            <Image
              ...
              className="ml-[10rem] md:ml-0 object-contain object-center rounded-full w-full max-w-[400px] xl:max-w-[749px] w-1920:w-[749px]"
            />

            <div className="md:hidden absolute top-[-2.5rem] right-0 left-[1rem] md:left-0 md:right-10 max-w-[200px] z-10">
          ...
          <div className="hidden md:flex md:flex-col w-full px-5 text-start xl:px-0 xl:flex-1 xl:justify-center xl:text-left">
            <div className="relative bg-white/80 backdrop-blur-md rounded-2xl p-8 shadow-2xl border border-white/50 w-fit">
              <span className="text-black/20 text-6xl font-serif leading-none select-none">
                "
              </span>
              ...
              <TextAnimated
                ...
                per="char"
                preset="fade"
                className="text-sm text-center md:text-left italic font-bold text-left text-black xl:text-lg mt-4"
              >
                {t("means")}
              </TextAnimated>
              <TextAnimated
                ...
                per="char"
                preset="fade"
                className="text-sm text-center md:text-left italic font-bold text-left text-black xl:text-lg mt-8"
              >
                "Austin Vu"
              </TextAnimated>
            </div>
