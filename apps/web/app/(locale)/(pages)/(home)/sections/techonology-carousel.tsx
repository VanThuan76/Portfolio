...
function WindowsIcon(props: SVGProps<SVGSVGElement>) {
    return (
        ...
        >
            <path
                fill="#00adef"
                d="M0 12.402l35.687-4.86.013 35.292-35.7.136zM39.663 6.643l48.337-7.143v42.103l-48.337.332zM0 45.922l35.687.124v35.151l-35.687-4.883zM39.663 46.254l48.337.525v41.221l-48.337-7.168z"
            />
        </svg>
    );
}
...
function TauriIcon(props: SVGProps<SVGSVGElement>) {
    return (
        ...
        >
            <path
                fill="#24C8DB"
                d="M128 0C57.31 0 0 57.31 0 128s57.31 128 128 128 128-57.31 128-128S198.69 0 128 0zm0 234.667c-58.81 0-106.667-47.857-106.667-106.667S69.19 21.333 128 21.333 234.667 69.19 234.667 128 186.81 234.667 128 234.667z"
            />
            <path fill="#24C8DB" d="M165.333 128l-53.333-32v64l53.333-32z" />
        </svg>
    );
}
...
const allLogos = [
    ...
    { name: "Windows", id: 2, img: WindowsIcon },
    { name: "Tauri", id: 3, img: TauriIcon },
    { name: "Apple", id: 4, img: AppleIcon },
    { name: "CEO Supabase", id: 5, img: SupabaseIcon },
    { name: "Vercel", id: 6, img: VercelIcon },
    { name: "Claude", id: 7, img: ClaudeAIIcon },
    { name: "Nextjs", id: 8, img: NextjsIcon },
    { name: "Tailwind", id: 9, img: TailwindCSSIcon },
    { name: "Upstash", id: 10, img: UpstashIcon },
    { name: "Typescript", id: 11, img: TypeScriptIcon },
    { name: "Stripe", id: 12, img: StripeIcon },
    { name: "OpenAI", id: 13, img: OpenAIIconBlack },
];
            ...
            <div className="flex flex-col items-center w-full max-w-screen-lg mx-auto space-y-8">
                <div className="flex flex-col items-center justify-center gap-2 max-w-fit">
                    <h2 className="text-xl font-bold md:text-3xl">
                        {t("title_technology_section")}
                    </h2>
                    <a href="https://www.newcult.co" target="_blank">
                        <p className="text-sm md:text-base">{t("des_technology_section")}</p>
                    </a>
                </div>
