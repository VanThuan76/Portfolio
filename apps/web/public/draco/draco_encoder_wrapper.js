...
$jscomp.polyfillUnisolated = function (l, p, m, r) {
  ...
  p != r &&
    null != p &&
    $jscomp.defineProperty(m, l, { configurable: !0, writable: !0, value: p });
};
...
$jscomp.polyfill(
  ...
  function (l) {
    ...
    k.race = function (h) {
      return new k(function (q, w) {
        for (
          var B = $jscomp.makeIterator(h), v = B.next();
          !v.done;
          v = B.next()
        )
...
var DracoEncoderModule = (function () {
  ...
  return function (p) {
    ...
    var La = (a._emscripten_bind_VoidPtr___destroy___0 = function () {
      ...
      vb =
        (a._emscripten_bind_PointCloudBuilder_SetNormalizedFlagForAttribute_3 =
          function () {
            return (vb =
              a._emscripten_bind_PointCloudBuilder_SetNormalizedFlagForAttribute_3 =
      ...
      wb = (a._emscripten_bind_PointCloudBuilder___destroy___0 = function () {
        return (wb = a._emscripten_bind_PointCloudBuilder___destroy___0 =
      ...
      xb = (a._emscripten_bind_MeshBuilder_AddFacesToMesh_3 = function () {
        return (xb = a._emscripten_bind_MeshBuilder_AddFacesToMesh_3 =
      ...
      zb = (a._emscripten_bind_MeshBuilder_AddInt32AttributeToMesh_5 =
        function () {
          return (zb =
      ...
      Ab = (a._emscripten_bind_MeshBuilder_AddMetadataToMesh_2 = function () {
        return (Ab = a._emscripten_bind_MeshBuilder_AddMetadataToMesh_2 =
          a.asm.ea).apply(null, arguments);
      }),
      Bb = (a._emscripten_bind_MeshBuilder_AddFloatAttribute_5 = function () {
        return (Bb = a._emscripten_bind_MeshBuilder_AddFloatAttribute_5 =
          a.asm.fa).apply(null, arguments);
      }),
      Cb = (a._emscripten_bind_MeshBuilder_AddInt8Attribute_5 = function () {
        return (Cb = a._emscripten_bind_MeshBuilder_AddInt8Attribute_5 =
          a.asm.ga).apply(null, arguments);
      }),
      Db = (a._emscripten_bind_MeshBuilder_AddUInt8Attribute_5 = function () {
        return (Db = a._emscripten_bind_MeshBuilder_AddUInt8Attribute_5 =
          a.asm.ha).apply(null, arguments);
      }),
      Eb = (a._emscripten_bind_MeshBuilder_AddInt16Attribute_5 = function () {
        return (Eb = a._emscripten_bind_MeshBuilder_AddInt16Attribute_5 =
          a.asm.ia).apply(null, arguments);
      }),
      Fb = (a._emscripten_bind_MeshBuilder_AddUInt16Attribute_5 = function () {
        return (Fb = a._emscripten_bind_MeshBuilder_AddUInt16Attribute_5 =
          a.asm.ja).apply(null, arguments);
      }),
      Gb = (a._emscripten_bind_MeshBuilder_AddInt32Attribute_5 = function () {
        return (Gb = a._emscripten_bind_MeshBuilder_AddInt32Attribute_5 =
          a.asm.ka).apply(null, arguments);
      }),
      Hb = (a._emscripten_bind_MeshBuilder_AddUInt32Attribute_5 = function () {
        return (Hb = a._emscripten_bind_MeshBuilder_AddUInt32Attribute_5 =
          a.asm.la).apply(null, arguments);
      }),
      Ib = (a._emscripten_bind_MeshBuilder_AddMetadata_2 = function () {
        return (Ib = a._emscripten_bind_MeshBuilder_AddMetadata_2 =
          a.asm.ma).apply(null, arguments);
      }),
      Jb = (a._emscripten_bind_MeshBuilder_SetMetadataForAttribute_3 =
        function () {
          return (Jb =
            a._emscripten_bind_MeshBuilder_SetMetadataForAttribute_3 =
              a.asm.na).apply(null, arguments);
        }),
      Kb = (a._emscripten_bind_MeshBuilder_SetNormalizedFlagForAttribute_3 =
        function () {
          return (Kb =
            a._emscripten_bind_MeshBuilder_SetNormalizedFlagForAttribute_3 =
              a.asm.oa).apply(null, arguments);
        }),
      Lb = (a._emscripten_bind_MeshBuilder___destroy___0 = function () {
        return (Lb = a._emscripten_bind_MeshBuilder___destroy___0 =
          a.asm.pa).apply(null, arguments);
      }),
      Da = (a._emscripten_bind_Encoder_Encoder_0 = function () {
        return (Da = a._emscripten_bind_Encoder_Encoder_0 = a.asm.qa).apply(
          null,
          arguments,
        );
      }),
      Mb = (a._emscripten_bind_Encoder_SetEncodingMethod_1 = function () {
        return (Mb = a._emscripten_bind_Encoder_SetEncodingMethod_1 =
          a.asm.ra).apply(null, arguments);
      }),
      Nb = (a._emscripten_bind_Encoder_SetAttributeQuantization_2 =
        function () {
          return (Nb = a._emscripten_bind_Encoder_SetAttributeQuantization_2 =
      ...
      Pb = (a._emscripten_bind_Encoder_SetSpeedOptions_2 = function () {
        return (Pb = a._emscripten_bind_Encoder_SetSpeedOptions_2 =
          a.asm.ua).apply(null, arguments);
      }),
      Qb = (a._emscripten_bind_Encoder_SetTrackEncodedProperties_1 =
        function () {
          return (Qb = a._emscripten_bind_Encoder_SetTrackEncodedProperties_1 =
            a.asm.va).apply(null, arguments);
        }),
      Rb = (a._emscripten_bind_Encoder_EncodeMeshToDracoBuffer_2 = function () {
        return (Rb = a._emscripten_bind_Encoder_EncodeMeshToDracoBuffer_2 =
          a.asm.wa).apply(null, arguments);
      }),
      Sb = (a._emscripten_bind_Encoder_EncodePointCloudToDracoBuffer_3 =
        function () {
          return (Sb =
            a._emscripten_bind_Encoder_EncodePointCloudToDracoBuffer_3 =
              a.asm.xa).apply(null, arguments);
        }),
      Tb = (a._emscripten_bind_Encoder_GetNumberOfEncodedPoints_0 =
        function () {
      ...
      Ub = (a._emscripten_bind_Encoder_GetNumberOfEncodedFaces_0 = function () {
        return (Ub = a._emscripten_bind_Encoder_GetNumberOfEncodedFaces_0 =
          a.asm.za).apply(null, arguments);
      }),
      Vb = (a._emscripten_bind_Encoder___destroy___0 = function () {
        return (Vb = a._emscripten_bind_Encoder___destroy___0 = a.asm.Aa).apply(
          null,
          arguments,
        );
      }),
      ...
      Wb = (a._emscripten_bind_ExpertEncoder_SetEncodingMethod_1 = function () {
        return (Wb = a._emscripten_bind_ExpertEncoder_SetEncodingMethod_1 =
          a.asm.Ca).apply(null, arguments);
      }),
      Xb = (a._emscripten_bind_ExpertEncoder_SetAttributeQuantization_2 =
        function () {
          return (Xb =
      ...
      Zb = (a._emscripten_bind_ExpertEncoder_SetSpeedOptions_2 = function () {
        return (Zb = a._emscripten_bind_ExpertEncoder_SetSpeedOptions_2 =
          a.asm.Fa).apply(null, arguments);
      }),
      ...
      ac = (a._emscripten_bind_ExpertEncoder_EncodeToDracoBuffer_2 =
        function () {
          return (ac = a._emscripten_bind_ExpertEncoder_EncodeToDracoBuffer_2 =
            a.asm.Ha).apply(null, arguments);
        }),
      ...
      dc = (a._emscripten_bind_ExpertEncoder___destroy___0 = function () {
        return (dc = a._emscripten_bind_ExpertEncoder___destroy___0 =
          a.asm.Ka).apply(null, arguments);
      }),
      ec = (a._emscripten_enum_draco_GeometryAttribute_Type_INVALID =
        function () {
          return (ec = a._emscripten_enum_draco_GeometryAttribute_Type_INVALID =
            a.asm.La).apply(null, arguments);
        }),
      fc = (a._emscripten_enum_draco_GeometryAttribute_Type_POSITION =
        function () {
          return (fc =
            a._emscripten_enum_draco_GeometryAttribute_Type_POSITION =
              a.asm.Ma).apply(null, arguments);
        }),
      gc = (a._emscripten_enum_draco_GeometryAttribute_Type_NORMAL =
        function () {
          return (gc = a._emscripten_enum_draco_GeometryAttribute_Type_NORMAL =
            a.asm.Na).apply(null, arguments);
        }),
      hc = (a._emscripten_enum_draco_GeometryAttribute_Type_COLOR =
        function () {
          return (hc = a._emscripten_enum_draco_GeometryAttribute_Type_COLOR =
            a.asm.Oa).apply(null, arguments);
        }),
      ic = (a._emscripten_enum_draco_GeometryAttribute_Type_TEX_COORD =
        function () {
          return (ic =
            a._emscripten_enum_draco_GeometryAttribute_Type_TEX_COORD =
              a.asm.Pa).apply(null, arguments);
        }),
      jc = (a._emscripten_enum_draco_GeometryAttribute_Type_GENERIC =
        function () {
          return (jc = a._emscripten_enum_draco_GeometryAttribute_Type_GENERIC =
      ...
      lc = (a._emscripten_enum_draco_EncodedGeometryType_POINT_CLOUD =
        function () {
          return (lc =
            a._emscripten_enum_draco_EncodedGeometryType_POINT_CLOUD =
              a.asm.Sa).apply(null, arguments);
        }),
      mc = (a._emscripten_enum_draco_EncodedGeometryType_TRIANGULAR_MESH =
        function () {
          return (mc =
    ...
    x.prototype.SetNormalizedFlagForAttribute =
      x.prototype.SetNormalizedFlagForAttribute = function (b, c, d) {
        var e = this.ptr;
        b && "object" === typeof b && (b = b.ptr);
        c && "object" === typeof c && (c = c.ptr);
        d && "object" === typeof d && (d = d.ptr);
    ...
    u.prototype.SetNormalizedFlagForAttribute =
      u.prototype.SetNormalizedFlagForAttribute = function (b, c, d) {
        var e = this.ptr;
        b && "object" === typeof b && (b = b.ptr);
        c && "object" === typeof c && (c = c.ptr);
        d && "object" === typeof d && (d = d.ptr);
