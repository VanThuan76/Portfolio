...
import { Bot, FolderOpenDot, GithubIcon, HomeIcon, Newspaper, PlusCircle } from "lucide-react";
  ...
  return (
    ...
    >
      <nav className="grid w-full grid-flow-col items-center justify-between rounded-16">
        <div className="relative flex h-full flex-col items-center justify-center pt-4 pb-2" onClick={() => router.push('/')}>
          <HomeIcon />
          <TypographyP title="Home" className="text-xs p-0 m-0" />
        </div>
        <div className="relative flex h-full flex-col items-center justify-center pt-4 pb-2" onClick={() => router.push('/project')}>
          <FolderOpenDot />
        ...
        <div className="flex w-[52px] h-[52px] rounded-[24px] group-hover:rounded-[16px] transition-all overflow-hidden items-center justify-center bg-background dark:bg-neutral-700 group-hover:bg-emerald-700">
          <ActionDrawer
            drawerTrigger={<PlusCircle className="group-hover:text-white transition" />}
            drawerContent={
              <div className="flex justify-between items-center">
                <div className="flex flex-col justify-center items-center" onClick={() => router.push('/extensions/chatbot')}>
                  <Bot />
                  <p>Chat AI</p>
                </div>
              </div>
        ...
        <div className="relative flex h-full flex-col items-center justify-center pt-4 pb-2" onClick={() => router.push('/blog')}>
          <Newspaper />
          <TypographyP title="Blog" className="text-xs p-0 m-0" />
        </div>
        <div className="relative flex h-full flex-col items-center justify-center pt-4 pb-2" onClick={() => router.push('/extensions/git-roll')}>
          <GithubIcon />
