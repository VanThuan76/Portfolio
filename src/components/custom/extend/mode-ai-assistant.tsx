...
const ModeAIAssistant = () => {
    ...
    return (
        ...
        >
            ...
            <div className="w-[35px] h-[35px] overflow-hidden rounded-full cursor-pointer" onClick={() => !permission && getMicrophonePermission()}>
                {pending && (
                    <LoaderImage src="/siri-active.gif"
                        isLoader={false}
                        alt="Siri Active"
                        width={100}
                        height={100}
