const { AIChatPlugin, useEditorChat } = require("@udecode/plate-ai/react");
const {
  PlateEditor,
  toDOMNode,
  useEditorPlugin,
...
import { useOpenAI } from "@repo/editor/components/openai/openai-context";
...
export function AIMenu() {
  ...
  const aiEditorRef = React.useRef<typeof PlateEditor | null>(null);
