...
const { CopilotPlugin } = require("@udecode/plate-ai/react");
...
import {
  ...
  CommandItem,
  CommandList,
} from "@repo/editor/components/command";
import {
  Dialog,
  DialogContent,
  DialogDescription,
  ...
  DialogTitle,
  DialogTrigger,
} from "@repo/editor/components/dialog";
import { Input } from "@repo/editor/components/input";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
} from "@repo/editor/components/popover";
