...
export const ImagePreview = () => {
  ...
  return (
    <div
      ...
      {...maskLayerProps}
    >
      <div className="absolute inset-0 bg-black size-full opacity-30"></div>
      <div className="absolute inset-0 bg-black size-full opacity-30"></div>
      <div className="absolute inset-0 flex items-center justify-center ">
        <div className="relative flex items-center w-full max-h-screen">
          <PreviewImage
            className={cn(
          ...
          />
          <div
            className="absolute bottom-0 z-40 flex justify-center gap-4 p-2 text-center text-white -translate-x-1/2 left-1/2 w-fit"
            ...
            <div className="flex ">
              ...
              <div className="mx-px">
                {state.isEditingScale ? (
                  <>
                    <ScaleInput className="w-10 px-1 rounded text-slate-500 outline" />{" "}
                    <span>%</span>
                  </>
                ) : (
