...
export const Experience = memo(
  ({ positions, breakpoint }: { positions: any; breakpoint: any }) => {
              ...
              <ModelCityBackground
                position={
                  positionModelCity.length > 0
                    ? (positionModelCity.slice(0, 3) as [
                        number,
                        number,
                        number,
                      ])
                ...
                scale={
                  positionModelCity.length > 0 ? [50, 50, 50] : [20, 20, 20]
                }
              />
            )}
          </Suspense>
            ...
            <ModelCastle
              position={
                positionModelCastle.length > 0
                  ? (positionModelCastle.slice(0, 3) as [
                      number,
                      number,
                      number,
                    ])
              ...
              scale={
                positionModelMountain.length > 0 ? [10, 10, 10] : [7, 7, 7]
              }
            />
          </Suspense>
              ...
              <ModelCaffe
                position={
                  positionModelCaffe.length > 0
                    ? (positionModelCaffe.slice(0, 3) as [
                        number,
                        number,
                        number,
                      ])
