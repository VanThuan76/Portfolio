...
export default function TextScrollReveal({ children, className, ...props }: TextScrollRevealProps) {
    ...
    return (
        ...
        >
            <div className="sticky top-0 flex items-start justify-start w-full h-full">
                <div className="flex flex-wrap w-full p-8 h-fit min-w-fit whitespace-break-spaces">
