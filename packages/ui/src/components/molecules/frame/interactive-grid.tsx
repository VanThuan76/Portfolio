...
const size = 24; // h-6
const boxClassName =
  "absolute bottom-1/2 h-6 w-6 rounded-md bg-transparent p-px border border-gray-400/30 border-box group ";
...
export default function InteractiveGrid({
  ...
  return (
    <div
      className={cn(
        "storybook-fix relative h-full w-full overflow-hidden rounded-3xl",
        className,
      )}
    >
      <Grid />
