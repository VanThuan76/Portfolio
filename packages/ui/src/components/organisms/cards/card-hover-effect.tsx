...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-sm h-full w-full p-4 overflow-hidden bg-black border-2 border-transparent dark:border-white/[0.2] group-hover:shadow-xl md:group-hover:border-black/40 relative z-20 transition-all ease-in-out duration-300",
        className,
      )}
    >
      <div className="relative z-50 h-[90px] md:h-auto flex items-start justify-start md:flex-col overflow-hidden">
        {children}
      </div>
    </div>
  );
