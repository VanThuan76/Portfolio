...
import {
  ...
  CommandEmpty,
  CommandList,
} from "@repo/design-system/components/molecules/other-utils/command";
...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "flex flex-wrap gap-1 p-1 py-2 border border-input shadow-sm rounded-lg bg-background",
        className,
      )}
      {...props}
    >
...
>(({ className, children }, ref) => {
  return (
    <CommandList
      ref={ref}
      className={cn(
        "p-2 flex flex-col gap-2 rounded-md scrollbar-thin scrollbar-track-transparent transition-colors scrollbar-thumb-muted-foreground dark:scrollbar-thumb-muted scrollbar-thumb-rounded-lg w-full absolute bg-background shadow-md z-10 border border-slate-300 top-0",
        className,
      )}
    >
      {children}
